	...
	public Optional<Customer> get(int id) {
		...
		try {
			...
			if(rs.next()) {
				...
				customer.setGender(Gender.fromValue(rs.getString("gender")));
				String maritalStatusValue = rs.getString("marital_status");
			    if (maritalStatusValue != null) {
			        MaritalStatus maritalStatus = MaritalStatus.valueOf(maritalStatusValue);
